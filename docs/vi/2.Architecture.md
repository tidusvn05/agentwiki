...
- **Môi trường**: chạy như CLI user-space thông thường trên Linux/macOS/Windows — không cần quyền root; có thể đặt lịch chạy định kỳ bằng cron, systemd --user timer, hoặc CI job.
